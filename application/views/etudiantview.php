...
<link href="<?php echo base_url(); ?>/assets/theme/assets/global/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css"/>
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/assets/theme/assets/global/plugins/select2/select2.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/assets/theme/assets/global/plugins/datatables/extensions/Scroller/css/dataTables.scroller.min.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/assets/theme/assets/global/plugins/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/assets/theme/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"/>
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.css">
<!-- END PAGE LEVEL STYLES -->
<!-- BEGIN THEME STYLES -->
<link href="<?php echo base_url(); ?>/assets/theme/assets/global/css/components-md.css" id="style_components" rel="stylesheet" type="text/css"/>
<link href="<?php echo base_url(); ?>/assets/theme/assets/global/css/plugins-md.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/css/layout.css" rel="stylesheet" type="text/css"/>
<link id="style_color" href="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
								<li>
									...
									<span class="photo">
									<img src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout3/img/avatar2.jpg" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Lisa Wong </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout3/img/avatar3.jpg" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Richard Doe </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout3/img/avatar1.jpg" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Bob Nilson </span>
				...
				<li class="dropdown dropdown-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" class="img-circle" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar3_small.jpg"/>
				...
				<div class="col-md-12">
					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Etudiants
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
								<a href="javascript:;" class="reload" onclick="myFunction()">
								</a>
							</div>
						</div>
						...
						<div  class="portlet-body">
							...
							<button   type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info btn-lg">Ajouter étudiant</button>
								<thead>
								<tr>
									<th>
								 		photo
						...
						<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar3.jpg" alt="...">
								...
								<li class="media">
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar1.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar4.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar2.jpg" alt="...">
									<div class="media-body">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar6.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar7.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar8.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar9.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar10.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar11.jpg" alt="...">
									<div class="media-body">
						...
						<div class="page-quick-sidebar-item">
							<div class="page-quick-sidebar-chat-user">
								...
								<div class="page-quick-sidebar-chat-user-messages">
									<div class="post out">
										<img class="avatar" alt="" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar3.jpg"/>
										<div class="message">
											<span class="arrow"></span>
									...
									<div class="post in">
										<img class="avatar" alt="" src="<?php echo base_url(); ?>/assets/theme/assets/admin/layout/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow"></span>
...
jQuery(document).ready(function() {   
 ...
 $('#mytable').DataTable({
 	"ajax": '<?=base_url()?>etudiant/getEventDatatable',
     ...
     $("#user_form").submit(function(e){
            e.preventDefault();
             ...
             var post_text = {
                ...
                var x = document.getElementById("modphoto").src;
                console.log("****************"+x);
            $.ajax({
                type: "POST",
                url: '<?php echo base_url();?>etudiant/insert',
...
function details(id){
	$.ajax({
		url:"../Etudiant/getetudiant/"+id,
		method:"POST",
		success:function(response){
		var etud=JSON.parse(response);
		$("#modprenom").text(etud.prenom);
		$("#modnom").text(etud.nom);
		$("#modcne").text(etud.cne);
		$("#modcin").text(etud.cin);
		$("#modemail").text(etud.email);
		$("#modtel").text(etud.tel);
		$("#modadr").text(etud.adresse);
		$("#moddate").text(etud.date_naissance);
		$("#modid").text("les informations de l'étudiant: "+etud.id_etudiant);
		document.getElementById('modphoto').src="../images/"+etud.photo;
...
function modifier(id){
	$.ajax({
		...
		success:function(response){
		var etud=JSON.parse(response);
		$("#prenom").val(etud.prenom);
		$("#nom").val(etud.nom);
		$("#cne").val(etud.cne);
		$("#cin").val(etud.cin);
		$("#email").val(etud.email);
		$("#tel").val(etud.tel);
		$("#adr").val(etud.adresse);
		$("#date").val(etud.date_naissance);
		$("#id").val("les informations de l'étudiant: "+etud.id_etudiant);
		document.getElementById('modphoto').src="../images/"+etud.photo;
...
<!-- END BODY -->
 ...
 <div id="userModal" class="modal fade">  
      <div class="modal-dialog">  
           <form enctype="multipart/form-data" method="post" id="user_form" action="">  
                <div class="modal-content">  
                     <div class="modal-header">  
								...
								<a href="javascript:;" class="remove">
									...
									<div class="portlet-body form">
										...
										<form class="form-horizontal" role="form">
											<div class="form-body">
												<h2 id="modid" class="margin-bottom-20">  </h2>
												...
												<div class="row">
												<div class="col-md-3">
													<img id="modphoto" width="150" height="200"">
												</div>
												<div id="omaima" class="col-md-9">
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Prènom:</label>
															<div class="col-md-9">
																<p id="modprenom" class="form-control-static">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<p id="modnom" class="form-control-static">
												...
												<!--/row-->
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">CNE:</label>
															<div class="col-md-9">
																<p id="modcne" class="form-control-static">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<p id ="modcin" class="form-control-static">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<p id="moddate" class="form-control-static">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<p id="modadr" class="form-control-static">
	...
	<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<p id="modemail" class="form-control-static">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<p id="modtel" class="form-control-static">
